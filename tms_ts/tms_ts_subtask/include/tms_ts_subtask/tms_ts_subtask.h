...
#include <tms_msg_rc/sp5_control_unity.h> //PRHL
#include <tms_msg_rp/rps_path_server.h>
//#include <tms_msg_rc/sp5_arm_control_unity.h> //PRHL
...
#include <tms_msg_ur/tms_ur_notification.h> //Notification
...
private:
  ...
  ros::ServiceClient turtlebot3_virtual_control_client;
  ros::ServiceClient get_virtual_data_client_;
  //ros::ServiceClient turtlebot3_sim_client;

  ros::ServiceClient sp5_unity_control_client;
  ros::ServiceClient sp5_unity_arm_control_client;
  ros::ServiceClient sp5_unity_path_client;
  //************
  ...
  ros::ServiceClient notification_server; // Notification
};
}
